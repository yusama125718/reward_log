...
StreamActions.set_reward_modal_value = function(){
...
StreamActions.set_display_modal_value = function(){
  if($("#q_"+ this.getAttribute("target") + "_eq").length){
    $("#q_" + this.getAttribute("target") + "_eq").val(this.getAttribute("value"));
  }
  else {
    $("#display_" + this.getAttribute("target")).val(this.getAttribute("value"));
  }
}
